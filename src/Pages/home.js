...
const Home = () => {
    ...
    <section className="Home">
        <section className="introdcution">
            ...
            <p>My name is <span>Roggero Spezialy</span> and this portfolio is made to help showcase the skills as well as the abilities I have learned while going through a coding bootcamp via SprinBoard or through self research on various platforms.</p>
